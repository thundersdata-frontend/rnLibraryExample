import { Button, Form, WhiteSpace, WingBlank } from '@td-design/react-native';
import { DatePickerInput, DatePickerItem, PickerInput, PickerItem } from '@td-design/react-native-picker';
...
export default function FormPickDemo() {
  const [form] = useForm();
