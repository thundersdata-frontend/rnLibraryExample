...
const { NumberKeyboardInput, NumberKeyboardItem } = NumberKeyboard;
          ...
          <WingBlank>
            <Form onFinish={handleFinish} form={form}>
              ...
              <FormListItem
                ...
                rules={[{ required: true, message: '请选择数量' }]}
              >
                <NumberKeyboardItem type="number" placeholder="请输入核定载质量" />
              </FormListItem>

              <FormItem type="all" name="count2" rules={[{ required: true, message: '请输入核定载质量' }]}>
                <NumberKeyboardInput label="核定载质量" type="number" placeholder="请输入核定载质量" />
              </FormItem>
            </Form>
          </WingBlank>
        </ScrollView>
